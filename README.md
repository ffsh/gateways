...
### Mesh Announce
Um als Gateway, Server oder alles was kein Freifunk Router ist auf der Karte zu erscheinen kann [https://github.com/ffnord/mesh-announce mesh-announce] installiert werden.
...
#### yanic
[https://github.com/FreifunkBremen/yanic yanic] sammelt von den Knoten Daten, welche dann auf einer Karte angezeigt werden können, früher wurde hierfür Alfred benutzt.
yanic ist in go geschrieben also installieren wir eine neue Version von go.
[https://golang.org/dl/ golang]
<pre>
...
<pre>
yanic query --wait 20 bat0 "fddf:0bf7:80::128:1"
</pre>
...
Hier wird [http://docs.grafana.org/installation/debian/ Grafana] über eine Repository installiert.
<pre>
...
##### nodejs
Wir brauchen ein aktuelles nodejs das finden wir auf [https://nodejs.org/en/download/package-manager/ nodejs.org]
...
##### yarn
Dann installieren wir [https://yarnpkg.com/en/docs/install#linux-tab yarn]
<pre>
...
##### meshviewer-rgb
Nun installieren wir den [https://doc.meshviewer.org/ meshviewer] selbst.
